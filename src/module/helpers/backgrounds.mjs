    ...
    return [
        {
            ...
            "background_bonus": {
                ...
                "benefit": "An Adeptus Administratum character counts the Availability of all items as one level more available (Very Rare items count as Rare, Average items count as Common, etc.).",
            },
        ...
        },
        {
            ...
            "background_bonus": {
                ...
                "benefit": "An Adeptus Mechanicus character counts the Availability of all cybernetics as two levels more available (Rare items count as Average, Very Rare items count as Scarce, etc.). Starting Trait: Mechanicus Implants."
            },
        ...
        },
        {
            ...
            "background_bonus": {
                ...
                "benefit": "When attacking a target that an ally attacked since the end of the Guardsman's last turn, the Guardsman can re-roll any results of 1 or 2 damage rolls."
            },
        ...
        },
        {
            ...
            "background_bonus": {
                ...
                "benefit": "Whenever an Adepta Sororitas Character would gain 1 or more Corruption Points, she gains that many Insanity Points minus 1 (to a minimum of 0) instead."
            },
        ...
        },
        {
            ...
            "starting_talents": "Weapon Training (Low-Tech, Solid Projectile) Also one of the following: Amphibious, Dark-sight, Natural Weapons, Sonar Sense, Sturdy, Toxic (1), Unnatural Agility (1), Unnatural Strength (1), or Unnatural Toughness (1)",
        ...
        },
        {
            ...
            "starting_equipment": "Stub revolver with 2 extra clips of Expander bullets or Man-Stopper rounds, 1 web grenade, combi-tool, flak cloak, filtration plugs, 1 dose of de-tox, dataslate, stab light",
            "background_bonus": {
                "name": "Master of Hidden Lores",
                "benefit": "When a Heretek makes a Tech-Use test to comprehend, use, repair, or modify an unfamiliar device, he gains a +20 bonus if he has one or more relevant Forbidden Lore skill specialisations at Rank 1 (Known) or higher."
            },
        ...
        },
        {
            ...
            "background_bonus": {
                ...
                "benefit": "An Imperial Navy character scores one additional degree of success on successful Ballistic Skill tests he makes against targets at Point-Blank range, at Short range, and with whom he is engaged in melee."
            },
        ...
        },
        {
            ...
            "background_bonus": {
                ...
                "benefit": "A character from a Rogue Trader Fleet gains a +10 bonus to Fear tests caused by aliens and a +20 bonus to Interaction skill tests with alien characters."
            },
        ...
        },
        {
            ...
            "starting_equipment": "Autopistol or stub revolver, shotgun, chainblade, Imperial robes, 3 doses of obscura or tranq, disguise kit or excruciator kit, rebreather, stab light or glow-globe",
            "background_bonus": {
                "name": "Touched by a Daemon",
                "benefit": "An Exorcised character starts with one Malignancy Chosen from the Malignancies table. An Exorcised character counts his Insanity bonus as 2 higher for purposes of avoiding Fear Tests. Additionally, he can never again become possessed by the same Daemon that once possessed him."
            },
