    ...
    return [
        ...
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'A garden world character halves the duration (rounded up) of any result from Table 8-11: Shock or Table 8-13: Mental Traumas, and can remove Insanity points for 50xp per point.'
            },
            'aptitude': 'Social',
            'wounds': '7+1d5',
            'source': 'PG 28 EO'
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'Whenever character reaches Rank 2 (Trained) in a Scholastic Lore skill, he also gains Rank 1 (Known) in one related or identical Forbidden Lore skill specialization of his choice. The GM is the final arbiter of whether the two specializations are related.',
            },
            'aptitude': 'Knowledge',
            'wounds': '8+1d5',
            'source': 'PG 30 EO'
        ...
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'A frontier world character gains a +20 bonus to Tech-use test when applying personal weapon modifications, and a +10 bonus when repairing damaged items.',
            },
        ...
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'While a death world character is surprised, non-surprised attackers do not gain the normal +30 bonus to their Weapon Skill and Ballistic Skill tests when targeting this character.',
            },
            'aptitude': 'Fieldcraft',
            'wounds': '9+1d5',
            'source': 'PG 26 EO'
        ...
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'One survives a penal colony by instinctively knowing who is in charge and who is a threat. A penal colony character begins with one Rank in the Common Lore (Underworld) and Scrutiny skills,and starts with the Peer (Criminal Cartels) talent.',
            },
            'aptitude': 'Toughness',
            'wounds': '10+1d5',
            'source': 'PG 28 EB'
        },
        {
            ...
            'home_world_bonus': {
                ...
                'benefit': 'Those who manage to leave a quarantine world learn how to keep secrets. Whenever the warband’s Subtlety would decrease, it decreases by 2 less (to a minimum reduction of 1).',
            },
            'aptitude': 'Fieldcraft',
            'wounds': '8+1d5',
            'source': 'PG 30 EB'
